...
<div className="faculty-container">
  ...
  <div className="faculty-data-container">
        ...
        <p className='user-info-value'>BRANCH <strong>{dataa.Branch||"N/A"}</strong></p>
        <p className='user-info-value'>SECTION <strong>{dataa.section||"N/A"}</strong></p>
        <p className='user-info-value'>SEMESTER <strong>{dataa.semester||"N/A"}</strong></p>
        <p className='user-info-value'>YEAR <strong>{dataa.Year||"N/A"}</strong></p>
        ...
        <p className='user-info-value'>ADMISSION DATE <strong>{dataa.admission_date||"N/A"}</strong></p>
        <p className='user-info-value'>PASSWORD <strong>{dataa.password||"N/A"}</strong></p>
        <p className='user-info-value'>AADHAR NO. <strong>{dataa.aadhar||"N/A"}</strong></p>
        <p className='user-info-value'>RELIGION <strong>{dataa.religion||"N/A"}</strong></p>
